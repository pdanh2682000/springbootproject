...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<a href="<c:url value='/admin' />" class="brand-link"> <img
		...
		<span class="brand-text font-weight-light">Admin DanhUy's</span>
	</a>
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			<div class="image">
				<img src="<c:url value='/templates/admin/dist/img/duyanh_avatar.jpg' />" class="img-circle elevation-2"
					alt="User Image">
			</div>
			<div class="info">
